...
void process_main(int argc, char** argv) {
    ...
    for (int i = 1; i == 1 || i < argc; ++i) {
        ...
        console_printf(0xd00, "The almighty Aakash-bot has been summoned to assist you! Ask him all of your deepest, most burning questions!\n");
        int f = 0;
        ...
        while (true) {
            ...
            if (!keep_going) {
                ...
                console_printf(0xA00, "Exited (*cough* escaped *cough*) successfully\n");
                sys_exit(0);
            }
            console_printf(0xB00, "Big Ka$h: ");
            if (n > 0 && buf[0] != '\n') {
