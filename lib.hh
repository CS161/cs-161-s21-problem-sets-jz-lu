...
#define SYSCALL_ARP             153            // Specify MAC address for transmitting
#define SYSCALL_ICMP            154            // Kernel-side ping protocol
#define SYSCALL_RESARP          155            // Resolve ARP
#define SYSCALL_GETARP          156            // Get ARP if not resolved
